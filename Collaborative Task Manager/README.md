...
Hi! I'm Bala, a **MERN Stack Developer**. This is a clone of popular project management application ** Collaborative Task Manager**. I have created it with **React** in frontend,  **Node and Express** for backend and **MongoDB** for storing data. For authentication **Firebase** is used.
<br>
<br>
